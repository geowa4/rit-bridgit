...
public class IntegerType extends Type
{
	...
	public IntegerType(Integer value) throws InvalidTypeException
	{
		super(value, Type.INTEGER_TYPE);
		this.value = value;
		validateTypes();
	}
	...
	public Type add(Type other) throws InvalidTypeException 
	{
		if(other.value instanceof Integer)
			return new IntegerType(value + (Integer) other.value);
	...
	public Type gt(Type other) throws InvalidTypeException 
	{
		if(other.value instanceof Number)
			return new BooleanType(value.doubleValue() > ((Number) other.value).doubleValue());
		else
